...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function [settings,acqData,ephData,trackData,obsData,statResults] = gsrx(fileName_input)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fileName_input = "defaultReceiverConfiguration.txt";
...
if isempty(fileName_input)
    ...
    settings = readSettings(fileName_input);
else
    settings = readSettings(fileName_input{1});
end
...
% Execute navigation
settings.sys.ls_type = 0;  % 2: ekf; 0: ols; 1:wls
